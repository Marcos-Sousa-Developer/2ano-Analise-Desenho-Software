...
public class User {
	...
	*/
    ...
    /** obtem o leilao com o id
     * @param idLeilao - id do leilao
	 * @return leilao com o id
	*/
    public Leilao getOutroLeilao(int idLeilao) {
    	return this.getOutrosLeiloes().get(idLeilao).get(idLeilao);
    }
	...
	*/
    public String licitar(Leilao L, float montante) {     
	...
	*/
    ...
    /** apresenta as informações do user em String
	 * @return informações do user em String
	*/
